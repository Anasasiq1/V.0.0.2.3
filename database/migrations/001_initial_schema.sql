-- =========================================================
-- MIGRATION 001: INITIAL COMPLETE SCHEMA FOR HM-Q HYPERLOCAL PLATFORM
-- Compatible with PostgreSQL 12+, MySQL 5.7+, MySQL 8.0+, MariaDB 10.3+
-- =========================================================
...
-- 10. PLATFORM TEMPLATE SETTINGS TABLE
...
-- 11. PLATFORM TEMPLATE VERSIONS TABLE
...
-- 12. STORE TEMPLATES TABLE (KEYED BY store_id)
...
-- 13. STORE TEMPLATE VERSIONS TABLE
